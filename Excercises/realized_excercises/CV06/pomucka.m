...
TH1 = cv6rmnc1 (u,y,P0,th0);            % RMNC
TH2 = cv6rmnc2 (u,y,P0,th0,lbd0);       % RMNC + staticky koeficient expononcialniho zapominani
[TH3, LBD] = cv6rmnc3 (u,y,P0,th0,lbd0); % RMNC + promenny koeficient expononcialniho zapominani
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
